...
public class Practice02StaticLayoutView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // 以绘制出带有换行的文字
        /*StaticLayout 的构造方法是StaticLayout(CharSequence source, TextPaint paint, int width, Layout.Alignment align, float spacingmult, float spacingadd, boolean includepad)，
        其中参数里： width 是文字区域的宽度，文字到达这个宽度后就会自动换行；
                    align 是文字的对齐方向；
...
//        canvas.drawText(text, 50, 100, textPaint);
        ...
        StaticLayout layout = new StaticLayout(text, textPaint, 400, Layout.Alignment.ALIGN_NORMAL, 1, 0, true);
